  ...
  return (
    <>
      ...
      <div className="lg:w-1/2">
        <img src={register} alt="Login" className="object-cover w-screen h-screen lg:h-screen" />
      </div>
        ...
        <div className="max-w-md w-full p-8 bg-white rounded-lg shadow-lg">
          ...
          <form>
            <div className="mb-4">
              ...
              <input type="text" id="username" name="username" className="border border-gray-300 rounded-md w-full py-2 px-3 focus:outline-none focus:border-blue-400" />
            </div>
            <div className="mb-4">
            ...
            <div className=''>
                <p>Already a User? <Link to={'/login'} className='bg-gray-600 rounded p-2'>Sign In</Link></p>
            </div>
          </form>
        </div>
      </div>
